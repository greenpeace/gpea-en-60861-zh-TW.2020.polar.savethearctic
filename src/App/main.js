...
const donateUrl =
  "https://act.greenpeace.org/page/4663/donate/1?campaign=polar&ref=savethearctic";
...
const thankYouPageRedirect =
  "https://act.greenpeace.org/page/4663/donate/1?campaign=polar&ref=savethearctic_thankyou_page";
...
const sharePage = () => {
  ...
  if (navigator.share) {
    ...
    window.open(baseURL + "?u=" + encodeURIComponent(shareFBUrl), "_blank");
  }
};
...
var pageInit = function () {
  ...
  $("#center_sign-form").validate({
    ...
    submitHandler: function (form) {
      ...
      $("#en__field_supporter_NOT_TAGGED_6").val(
        $("#center_yearofbirth").val()
      );
